...
<body class="d-flex ">
    ...
    <!-- Main Section -->
        <div class="container vh-100 d-flex align-items-center">
            <div class="auth_container shadow  rounded overflow-hidden border">
                <!-- Login -->
                <div id="Log_in">
                    <h2 class="bg-dark text-white w-100 text-center p-2">Log In</h2>
                    <div class="role_btn">
                ...
                <?php
                        ...
                        ?>
                <div id="sign_up" class="rounded">
                    <h2 class="bg-dark text-white w-100 text-center p-2">Sign Up</h2>
