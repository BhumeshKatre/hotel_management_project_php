...
--
-- Database: `AJ Hotelhotel`
-- User: `AJ Hotel_user`
-- Password:   `password`
--
DROP DATABASE IF EXISTS AJ Hotelhotel;
CREATE DATABASE IF NOT EXISTS AJ Hotelhotel;

DROP USER IF EXISTS'AJ Hotel_user'@'%';
CREATE USER IF NOT EXISTS 'AJ Hotel_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON AJ Hotelhotel.* TO 'AJ Hotel_user'@'%';
USE AJ Hotelhotel;
